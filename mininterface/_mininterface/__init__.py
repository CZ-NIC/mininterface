...
class Mininterface(Generic[EnvClass]):
    ...
    @overload
    def form(self, form: None = None, title: str = "", *, submit: str | bool = True) -> EnvClass: ...
    @overload
    def form(self, form: FormDict, title: str = "", *, submit: str | bool = True) -> FormDict: ...
    @overload
    def form(self, form: Type[DataClass], title: str = "", *, submit: str | bool = True) -> DataClass: ...
    @overload
    def form(self, form: DataClass, title: str = "", *, submit: str | bool = True) -> DataClass: ...
