...
You're using positional arguments, subparsers, types in the ArgumentParser... Mininterface will give you an immediate benefit. Just wrap it in the [`run`][mininterface.run] method.
...
You then access the arguments through [`m.env`][mininterface.Mininterface.env]:
