...
class TestTag(TestAbstract):
    ...
    def test_mnemonic(self):
        ...
        self.assertListEqual(
            [('foo1', 'o'), ('important_number', 'i'), ('foo2', '3'),
             ('foo3', 'g'), ('foo4', None), ('foo5', 'f'), ('foo6', 'a'), ('foo7', 'b')],
            _(UiSettings()))

        self.assertListEqual(
            [('foo1', None), ('important_number', None), ('foo2', None),
             ('foo3', None), ('foo4', None), ('foo5', None), ('foo6', None), ('foo7', None)],
            _(UiSettings(mnemonic=False)))

        self.assertListEqual(
            [('foo1', 'o'), ('important_number', None), ('foo2', '3'),
             ('foo3', 'g'), ('foo4', None), ('foo5', 'f'), ('foo6', 'a'), ('foo7', None)],
